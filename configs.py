...
STREAM_LOGS = environ.get('STREAM_LOGS','-1002354213433')
...
class Config(object):
	...
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://bro90720:Mw5HlzWA2m20NYsF@cluster0.vs05h.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002216530469")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002322776019")
	...
	LAZY_PIC = os.environ.get("LAZY_PIC","https://envs.sh/Bwj.jpg")
...
🤖 **Wᴇʟᴄᴏᴍᴇ ᴛᴏ ᴛʜᴇ** [Sᴘɪʀɪᴛs Hᴇɴᴛᴀɪ Fɪʟᴇ Sᴛᴏʀᴇ Bᴏᴛ](https://t.me/{BOT_USERNAME})

Jᴏɪɴ Oᴜʀ Gʀᴏᴜᴘs!

👥 **Mᴀɪɴ Cʜᴀɴɴᴇʟ** [Mᴀɪɴ Cʜᴀɴɴᴇʟ](https://t.me/+leNickEW-dtmMGRl)

📢 **Cʜᴀᴛ Gʀᴏᴜᴘ** [Cʜᴀᴛ Gʀᴏᴜᴘ](https://t.me/anime_help_group)
"""
	#ABOUT_DEV_TEXT = f"""
