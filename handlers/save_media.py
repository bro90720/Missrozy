...
async def save_batch_media_in_channel(bot: Client, editable: Message, message_ids: list):
    try:
        ...
        share_link = f"https://t.me/{Config.BOT_USERNAME}?start=sadspirit7_{str_to_b64(str(SaveMessage.id))}"
        await editable.edit(
            f"**Bᴀtᴄʜ Fɪʟᴇs Sᴛᴏʀᴇd Iɴ Mʏ DᴀtᴀBᴀsᴇ!**\n\nHᴇʀᴇ I s ᴛʜᴇ Pᴇʀᴍᴀɴᴇɴᴛ Lɪɴᴋ Oꜰ Yᴏᴜʀ Fɪʟᴇs: {share_link} \n\n"
            f"Jᴜsᴛ Cʟɪᴄᴋ Tʜᴇ Lɪɴᴋ Tᴏ Gᴇᴛ Yᴏᴜʀ Fɪʟᴇs!",
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("⚡️ Open Link ⚡️", url=share_link)],
                 [InlineKeyboardButton("Mᴀɪɴ Cʜᴀɴɴᴇʟ", url="https://t.me/+leNickEW-dtmMGRl"),
                  InlineKeyboardButton("Cʜᴀᴛ Gʀᴏᴜᴘ", url="https://t.me/anime_help_group")]]
            ),
            disable_web_page_preview=True
        )
        await bot.send_message(
            chat_id=int(Config.LOG_CHANNEL),
            text=f"#BATCH_SAVE:\n\n[{editable.reply_to_message.from_user.first_name}](tg://user?id={editable.reply_to_message.from_user.id}) Gᴏᴛ Bᴀtᴄʜ Lɪɴᴋ!",
            disable_web_page_preview=True,
        ...
        if(Config.LAZY_MODE == True):
            ...
            lazy_dev = f"+> ᴛʜᴀɴᴋ ʏᴏᴜ <a href='https://t.me/sadspirit7'>⎝⎝✧Sᴘɪʀɪᴛ 7✧⎠⎠</a>"
